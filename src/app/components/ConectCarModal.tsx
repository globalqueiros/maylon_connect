...
export default function ConectCarModal({
  onClose,
  beneficioId,
}: ConectCarModalProps) {
  ...
  async function enviarSolicitacao() {
    ...
    if (placaLimpa.length !== 7) {
      setErro("Informe uma placa válida.");
      return;
    }
    ...
    try {
      const resposta = await fetch("/api/beneficios/conectcar", {
        method: "POST",
        headers: {
  ...
  const inputClass =
    "w-full rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none transition focus:border-slate-700 focus:ring-4 focus:ring-slate-700/10";
      ...
      >
        <div className="flex items-center justify-between bg-slate-900 px-6 py-5 text-white">
          ...
          <button
            ...
            onClick={onClose}
            disabled={enviando}
            className="cursor-pointer rounded-full p-2 transition hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-50"
          >
            <X size={22} />
          </button>
        </div>
          ...
          {sucesso ? (
            <div className="py-8 text-center">
              ...
              <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-500">
                Recebemos sua solicitação da Tag ConectCar.
              </p>

              {protocolo && (
                <div className="mx-auto mt-5 max-w-sm rounded-2xl bg-slate-100 p-4">
              ...
              <button
                type="button"
                onClick={onClose}
                className="mt-7 cursor-pointer rounded-xl bg-slate-900 px-8 py-3 text-sm font-bold text-white transition hover:bg-slate-800"
              >
                Fechar
              </button>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Use sua Tag para facilitar o pagamento em pedágios,
                  Free Flow e estacionamentos participantes.
                </p>
              </div>
              ...
              <section className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Confira seus dados pessoais antes de enviar a solicitação.
                  </p>
                </div>
              ...
              <section className="space-y-4 rounded-2xl border border-slate-200 p-5">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Informe o veículo que utilizará a Tag ConectCar.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    value={placa}
                    onChange={(event) =>
                      setPlaca(formatarPlaca(event.target.value))
                    }
                    placeholder="ABC1D23"
                    maxLength={7}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      {buscandoCep && (
                        <Loader2
                          size={18}
                          className="absolute right-4 top-1/2 -translate-y-1/2 animate-spin text-slate-700"
                        />
                      )}
                    </div>
                  </div>
              ...
              <section>
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none transition focus:border-slate-700 focus:ring-4 focus:ring-slate-700/10"
                />
              </section>
              ...
              <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                ...
                <span className="text-xs leading-5 text-slate-600">
                  Declaro que li e concordo com os termos da solicitação
                  e autorizo o tratamento dos meus dados para análise do
                  benefício.
                </span>
              </label>
              ...
              <div className="flex flex-col-reverse gap-3 border-t border-slate-100 pt-5 sm:flex-row sm:justify-end">
                ...
                <button
                  ...
                  className="flex cursor-pointer items-center justify-center gap-2 rounded-xl bg-slate-900 px-6 py-3 text-sm font-bold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-300"
                >
                  {enviando ? (
                    <>
                      <Loader2

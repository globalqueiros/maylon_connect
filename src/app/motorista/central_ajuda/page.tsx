...
export default function CentralAjudaPage() {
  ...
  const gerarProtocoloPersistente = () => {
    if (typeof window === "undefined") {
      return "";
    }
    ...
    const salvoTempo =
      localStorage.getItem("protocolo_time");
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-700">
      ...
      <main className="mx-auto w-full max-w-[1600px] px-4 pb-10 sm:px-6 lg:px-8">
        <section className="relative overflow-hidden rounded-[36px] bg-gradient-to-br from-[#115e59] via-[#0f766e] to-[#0d9488] shadow-[0_30px_90px_rgba(15,118,110,0.20)]">
          ...
          <div className="relative grid gap-10 px-6 py-9 sm:px-9 lg:grid-cols-[1fr_auto] lg:px-12 lg:py-12">
            <div className="max-w-3xl">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#99f6e4]">
                Central de atendimento
              </p>

              <h1 className="mt-4 text-4xl font-black leading-[1.04] tracking-[-0.04em] text-white sm:text-5xl">
                Estamos aqui para
              ...
              <p className="mt-4 max-w-2xl text-sm leading-6 text-white/65">
                Tire suas dúvidas, converse com nossa
                equipe ou registre uma solicitação. Tudo
                organizado em um único espaço de
                atendimento.
              </p>
            </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            >
              ...
              <div className="relative mt-7">
                ...
                <p className="mt-2 text-sm leading-6 text-gray-400">
                  Converse com um atendente em tempo
                  real.
                </p>
              ...
              >
                ...
                <div className="mt-7 flex flex-col-reverse gap-3 border-t border-gray-100 pt-6 sm:flex-row sm:justify-end">
                  ...
                  <button
                    type="submit"
                    disabled={enviando}
                    className={`inline-flex h-12 items-center justify-center gap-2 rounded-2xl px-7 text-xs font-black text-white shadow-lg transition ${
                      enviando
                        ? "cursor-not-allowed bg-gray-400"
                        : "cursor-pointer bg-[#0f766e] shadow-[#0f766e]/20 hover:-translate-y-0.5 hover:bg-[#115e59]"
                    }`}
                  >
                    <Send size={16} />
                  ...
                  <tbody className="divide-y divide-gray-100">
                    ...
                    0 ? (
                      ...
                      protocolosFiltrados.map(
                        (item, index) => (
                          <tr
                            key={`${item.codigo || "protocolo"}-${index}`}
